...
GTCEuStartupEvents.registry("gtceu:world_gen_layer", (event) => {
  ...
  event
    ...
    .dimensions("minecraft:overworld");
  event
    .create("dacite_biomes")
    .targets("biomeswevegone:dacite", "#minecraft:stone_ore_replaceables")
    .dimensions("minecraft:overworld");
  event
    .create("first_layer_inf")
    .targets("infinite_abyss:deepstone", "minecraft:deepslate")
    .dimensions("infinite_abyss:first_layer");
  event
    .create("second_layer_inf")
