const RemoveOres = (event) => {
  ...
  var oreListInfLayers = ["infinite_abyss:opal_ore"];
  ...
  var oreListImmersiveEngineering = [
  ...
  // {
  //     props.worldgenLayer = 'underground_decorations'
  //     props.blocks = oreListImmersiveEngineering
  // }
  // )
  // event.removeOres(props =>
  // {
