const ModifyVanillaMobLootTable = (event) => {
  ...
  event.addEntityLootModifier("minecraft:zombie_villager").pool((pool) => {
    pool.rolls([1, 3]);
  ...
  event.addEntityLootModifier("minecraft:zombified_piglin").pool((pool) => {
    pool.rolls([0, 1]);
    pool.randomChance(0.1);
    pool
      .customCondition({
  ...
  event.addEntityLootModifier("minecraft:wither_skeleton").pool((pool) => {
    pool.rolls([0, 1]);
    pool.randomChance(0.1);
    pool
      .customCondition({
