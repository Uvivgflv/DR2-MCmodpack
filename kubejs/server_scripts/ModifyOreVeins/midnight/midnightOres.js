    ...
    vein.layeredVeinGenerator((generator) =>
      generator.buildLayerPattern((pattern) =>
        pattern
          .layer((l) => l.weight(4).mat(GTMaterials.get("tenebrum")).size(4, 5))
          .layer((l) =>
            l.weight(4).mat(GTMaterials.get("nagrilite")).size(3, 5),
          )
  ...
  event.add("kubejs:midnight_night_crystal", (vein) => {
    ...
    vein.layeredVeinGenerator((generator) =>
      generator.buildLayerPattern((pattern) =>
        pattern
          .layer((l) =>
            l.weight(4).mat(GTMaterials.get("night_crystal")).size(4, 5),
          )
  ...
  event.add("kubejs:midnight_dark_pearl", (vein) => {
    ...
    vein.layeredVeinGenerator((generator) =>
      generator.buildLayerPattern((pattern) =>
        pattern
          .layer((l) =>
            l.weight(4).mat(GTMaterials.get("dark_pearl")).size(4, 5),
          )
    ...
    vein.layeredVeinGenerator((generator) =>
      generator.buildLayerPattern((pattern) =>
        pattern
          ...
          .layer((l) =>
            l.weight(4).mat(GTMaterials.VanadiumMagnetite).size(3, 5),
          )
