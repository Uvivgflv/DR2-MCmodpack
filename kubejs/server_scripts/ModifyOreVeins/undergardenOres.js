    ...
    vein.layeredVeinGenerator((generator) =>
      generator.buildLayerPattern((pattern) =>
        pattern
          ...
          .layer((l) =>
            l.weight(1).mat(GTMaterials.get("cloggrum")).size(1, 2),
          ),
      ),
    );
  });
      ...
      generator.buildLayerPattern((pattern) =>
        pattern
          ...
          .layer((l) =>
            l
              .weight(1)
              .block(() => Block.getBlock("undergarden:depthrock_regalium_ore"))
              .size(1, 1),
          ),
      ),
    );
      ...
      generator.buildLayerPattern((pattern) =>
        pattern
          ...
          .layer((l) =>
            l
              .weight(3)
              .block(() => Block.getBlock("undergarden:depthrock_utherium_ore"))
              .size(2, 3),
          ),
      ),
    );
    ...
    vein.layeredVeinGenerator((generator) =>
      generator.buildLayerPattern((pattern) =>
        pattern
          ...
          .layer((l) =>
            l.weight(3).mat(GTMaterials.TricalciumPhosphate).size(1, 2),
          )
