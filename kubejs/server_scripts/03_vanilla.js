const RegisterVanillaRecipes = (event) => {
  ...
  //rewrite to function
  event
    .shaped("quark:ancient_chest", ["AAA", "ABA", "AAA"], {
  ...
  event
    .shaped("quark:azalea_chest", ["AAA", "ABA", "AAA"], {
  ...
  event
    .shaped("quark:blossom_chest", ["AAA", "ABA", "AAA"], {
  ...
  event
    .shaped("quark:oak_chest", ["AAA", "ABA", "AAA"], {
  ...
  event
    .shaped("quark:spruce_chest", ["AAA", "ABA", "AAA"], {
  ...
  event
    .shaped("quark:birch_chest", ["AAA", "ABA", "AAA"], {
  ...
  event
    .shaped("quark:jungle_chest", ["AAA", "ABA", "AAA"], {
  ...
  event
    .shaped("quark:acacia_chest", ["AAA", "ABA", "AAA"], {
  ...
  event
    .shaped("quark:dark_oak_chest", ["AAA", "ABA", "AAA"], {
  ...
  event
    .shaped("quark:crimson_chest", ["AAA", "ABA", "AAA"], {
  ...
  event
    .shaped("quark:warped_chest", ["AAA", "ABA", "AAA"], {
  ...
  event
    .shaped("quark:mangrove_chest", ["AAA", "ABA", "AAA"], {
  ...
  event
    .shaped("quark:cherry_chest", ["AAA", "ABA", "AAA"], {
  ...
  event
    .shaped("quark:bamboo_chest", ["AAA", "ABA", "AAA"], {
