const GlobalLootTablesRegistry = (event) => {
  ...
  const AddHillsLoot = ["gtceu:raw_garnierite_block", "gtceu:raw_cobalt_block"];
  ...
  AddHillsLoot.forEach((element) => {
    event
      .addLootTableModifier(/^twilightforest:chests\/hill_.*/)
      .randomChance(0.67)
      .addLoot(element);
  });
  //#endregion
    ...
    event
      ...
      .addLoot(
        Item.of(
          ...
          `{SchoolId:"irons_spellbooks:${school_id}"}`,
        ),
      );
  });
