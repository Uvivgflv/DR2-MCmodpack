const RegistryCreateGTMCrafterRecipes = (event) => {
  ...
  event
    .custom({
      ...
      key: {
        I: { tag: "forge:double_plates/invar" },
        C: { tag: "gtceu:circuits/lv" },
        R: { item: "gtceu:copper_quadruple_wire" },
        S: { item: "gtceu:lv_machine_hull" },
        V: { item: "gtceu:tin_single_cable" },
      },
      pattern: [" III ", "ICRCI", "IRSRI", " VRV "],
      result: {
        count: 1,
  ...
  event
    .custom({
      ...
      pattern: [" DDD ", "DCMCD", "DM MD", "DCMCD", " OHO "],
      result: {
        count: 1,
  ...
  event
    .custom({
      ...
      pattern: ["  CCCD", " ODDDD", "DHLLLD", " OPGPD", "  TTTD"],
      result: {
        count: 1,
