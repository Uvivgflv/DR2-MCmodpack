                ...
                if (mat < 12352) {
                    if (mat < 12320) {
                        if (mat < 12304) {
                            ...
                            if (mat < 12312) {
                                // block.12304 = fluorescent_cattail
                                if (
                        ...
                        if (mat < 12336) {
                            ...
                            if (mat < 12344) {
                                // block.12336 = white_overgrown_dacite
                                if (mat % 8 == 0) {  // Grass
                                    if (glColor.b < 0.999) { // Grass Block:Normal:Grass Part
                                        smoothnessG = pow2(pow2(color.g)) * 0.5;
                                        smoothnessD = smoothnessG;
                    ...
                    if (mat < 12384) {
                        if (mat < 12368) {
                            if (mat < 12360) {
                                if (mat < 12356) {
                                    // block.12352 = blackstone_bulb
                                    emission = pow2(pow2(color.r));
                                } else /*if (mat < 12360)*/ {
                                    // block.12356 = brimstone
                            ...
                            if (mat < 12376) {
                                if (mat < 12372) {
                                    // block.12368 = glowflower
                                    subsurfaceMode = 1, noDirectionalShading = true, isFoliage = true;
                                
                                    emission = 2.0 * pow2(5.0 * max0(color.r - 0.8));
                                    color.rgb = pow1_5(color.rgb);
                                } else /*if (mat < 12376)*/ {
                                    // block.12372 = glowshroom
                                ...
                                if (mat < 12380) {
                                    ...
                                    // block.12380 = potted_burning_blossom
                                    noSmoothLighting = true;
                        ...
                        if (mat < 12400) {
                            if (mat < 12392) {
                                ...
                                if (mat < 12396) {
                                    ...
                                    // block.12396 = rose_quartz_cluster
                                    materialMask = OSIEBCA; // Intense Fresnel
                            ...
                            if (mat < 12408) {
                                if (mat < 12404) {
                                    // block.12400 = spider_egg
                                    if (color.r - color.b > 0.2) {
                                        emission = 0.7 * sqrt1(color.r) + 0.3;
                                    }
                                } else /*if (mat < 12408)*/ {
                                    // block.12404 = blooming_witch_hazel_leaves
                                    #include "/lib/materials/specificMaterials/terrain/leaves.glsl"
                                    lmCoordM.x *= 0.77;
                                ...
                                if (mat < 12412) {
                                    // block.12408 = fairy_slipper
                                    subsurfaceMode = 1, noDirectionalShading = true, isFoliage = true;
                                
                                    emission = color.r > 0.78 ? 0.8 * pow2(pow2(color.r)) : 0.0;
                                } else /*if (mat < 12416)*/ {
                                    // block.12412 = flowering_spirit_leaves
                                    #include "/lib/materials/specificMaterials/terrain/leaves.glsl"
                ...
                if (mat < 12480) {
                    if (mat < 12448) {
                        if (mat < 12432) {
                            ...
                            if (mat < 12440) {
                                if (mat < 12436) {
                                    // block.12432 = potted_fairy_slipper
                                    noSmoothLighting = true;
                    ...
                    if (mat < 12512) {
                        if (mat < 12496) {
                            if (mat < 12488) {
                                if (mat < 12484) {
                                    // block.12480 = stained_scrap
                                    #include "/lib/materials/specificMaterials/terrain/stainedScrap.glsl"
                                } else /*if (mat < 12488)*/ {
                                    // block.12484 = chorus_flower
                            ...
                            if (mat < 12504) {
                                if (mat < 12500) {
                                    ...
                                    // block.12500 = blackstone_cabinet
                                    if (color.r > color.b * 3.0) { // Gilded Blackstone:Gilded Part
                                        #include "/lib/materials/specificMaterials/terrain/rawGoldBlock.glsl"
                                        #ifdef GLOWING_ORE_GILDEDBLACKSTONE
                                            emission = color.g * 1.5;
                        ...
                        if (mat < 12528) {
                            if (mat < 12520) {
                                ...
                                if (mat < 12524) {
                                    // block.12520 = ancient_burning_skull_block
                                    if (
                                        color.r > 3.0 * color.b ||
                            ...
                            if (mat < 12536) {
                                ...
                                if (mat < 12540) {
                                    ...
                                    // block.12540 = ancient_skeleton_skull_candle
                                    #ifdef GBUFFERS_TERRAIN
                                        vec3 fractPos = fract(playerPos.xyz + cameraPosition.xyz);
                ...
                if (mat < 12608) {
                    if (mat < 12576) {
                        if (mat < 12560) {
                            ...
                            if (mat < 12568) {
                                if (mat < 12564) {
                                    // block.12560 = burning_skull_block
                        ...
                        if (mat < 12592) {
                            if (mat < 12584) {
                                ...
                                if (mat < 12588) {
                                    // block.12584 = ectoplasm
                                    const uint voxelNumbers[4] = uint[](232u, 232u, 232u, 232u);
                                    uint voxelNumber = voxelNumbers[mat % 4];
                                    lmCoordM = vec2(0.0);
                            ...
                            if (mat < 12600) {
                                ...
                                if (mat < 12604) {
                                    ...
                                    // block.12604 = rusty_netherite_grate
                                    smoothnessG = pow2(color.r);
                                    smoothnessG = min1(smoothnessG);
                                    smoothnessD = smoothnessG;
                        ...
                        if (mat < 12624) {
                            if (mat < 12616) {
                                if (mat < 12612) {
                                    ...
                                    // block.12612 = skeleton_skull_candle
                                    #ifdef GBUFFERS_TERRAIN
                                        vec3 fractPos = fract(playerPos.xyz + cameraPosition.xyz);
                                        if (fractPos.y < 0.5 && abs(NdotU) < 0.1) {  // side of skull
                                            if (color.r > 0.98 || color.r > 1.7 * color.g) {
                                ...
                                if (mat < 12620) {
                                    ...
                                    // block.12620 = soul_burning_skull_block
                            ...
                            if (mat < 12632) {
                                ...
                                if (mat < 12636) {
                                    // block.12632 = soul_skeleton_skull_candle
                                    #ifdef GBUFFERS_TERRAIN
                                        vec3 fractPos = fract(playerPos.xyz + cameraPosition.xyz);
                                        if (fractPos.y < 0.5 && abs(NdotU) < 0.1) {  // side of skull
                                            if (color.b - color.r > 0.15 || color.b > 0.98) {
                        ...
                        if (mat < 12656) {
                            if (mat < 12648) {
                                if (mat < 12644) {
                                    ...
                                    // block.12644 = treacherous_candle
                                    if (mat % 4 == 0) {
                                        #ifdef GBUFFERS_TERRAIN
                                ...
                                if (mat < 12652) {
                                    // block.12648 = twisting_vines
                                    const uint voxelNumbers[4] = uint[](235u, -1u, 236u, -1u);
                                    uint voxelNumber = voxelNumbers[mat % 4];
                                    noSmoothLighting = true;
                ...
                if (mat < 12736) {
                    if (mat < 12704) {
                        if (mat < 12688) {
                            ...
                            if (mat < 12696) {
                                if (mat < 12692) {
                                    // block.12688 = blackstone_furnace
                                    #include "/lib/materials/specificMaterials/terrain/blackstone.glsl"
                                    if (mat % 4 == 0) {
                                        lmCoordM.x *= 0.98;
                                ...
                                if (mat < 12700) {
                                    // block.12696 = blue_nether_bricks
                                    ...
                                    // block.12700 = white_corundum_cluster
                    ...
                    if (mat < 12768) {
                        if (mat < 12752) {
                            ...
                            if (mat < 12760) {
                                if (mat < 12756) {
                                    // block.12752 = quark_potted_plants
                                    noSmoothLighting = true;
                                    ...
                                    // block.12756 = quark_potted_plants_2
                                    noSmoothLighting = true;
                                ...
                                if (mat < 12764) {
                                    // block.12760 = quark_potted_plants_3
                                    noSmoothLighting = true;
                        ...
                        if (mat < 12784) {
                            if (mat < 12776) {
                                if (mat < 12772) {
                                    // block.12768 = redstone_randomizer
                                    #if ANISOTROPIC_FILTER > 0
                                        color = texture2D(tex, texCoord); // Fixes artifacts
                                        color.rgb *= glColor.rgb;
                                    #endif
            ...
            if (mat < 12832) {
                ...
                if (mat < 12848) {
                    if (mat < 12840) {
                        ...
                        if (mat < 12844) {
                            // block.12840 = redstone_illuminator
                    ...
                    if (mat < 12856) {
                        if (mat < 12852) {
                            // block.12848 = soap_block
                            smoothnessG = pow2(color.r) * 0.4;
                            smoothnessD = smoothnessG;
                            highlightMult = 1.5;
                        } else /*if (mat < 12856)*/ {
                            // block.12852 = stone_lamp
                            if (color.r > 0.7) {
                                lmCoordM = vec2(1.0, 0.0);
                        ...
                        if (mat < 12860) {
                            // block.12856 = sugar_cube
                            smoothnessG = pow(color.g, 16.0) * 2.0;
                            smoothnessD = smoothnessG * 0.7;
                            highlightMult = 2.0;
                        } else /*if (mat < 12864)*/ {
                            // block.12860 = paper_lantern
